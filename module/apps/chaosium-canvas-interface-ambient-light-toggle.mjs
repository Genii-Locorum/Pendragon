...
export default class ChaosiumCanvasInterfaceAmbientLightToggle extends ChaosiumCanvasInterface {
  static get actionToggles () {
    ...
    buttons[ChaosiumCanvasInterface.actionToggle.On] = 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Action.On'
    buttons[ChaosiumCanvasInterface.actionToggle.Off] = 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Action.Off'
    return buttons
  }
  ...
  static defineSchema () {
    ...
    return {
      triggerButton: new fields.NumberField({
        ...
        label: 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Button.Title',
        hint: 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Button.Hint'
      }),
      action: new fields.NumberField({
        ...
        label: 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Action.Title',
        hint: 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Action.Hint',
        required: true
      }),
      lightUuids: new fields.SetField(
        ...
        {
          label: 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Light.Title',
          hint: 'PEN.ChaosiumCanvasInterface.AmbientLightToggle.Light.Hint'
        }
      )
    }
  }
