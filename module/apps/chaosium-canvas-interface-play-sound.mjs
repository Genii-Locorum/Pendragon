...
export default class ChaosiumCanvasInterfacePlaySound extends ChaosiumCanvasInterface {
  static get actionToggles () {
    ...
    buttons[ChaosiumCanvasInterface.actionToggle.On] = 'PEN.ChaosiumCanvasInterface.PlaySound.Action.Play'
    buttons[ChaosiumCanvasInterface.actionToggle.Off] = 'PEN.ChaosiumCanvasInterface.PlaySound.Action.Stop'
    return buttons
  }
  ...
  static defineSchema () {
    ...
    return {
      ...
      action: new fields.NumberField({
        ...
        label: 'PEN.ChaosiumCanvasInterface.PlaySound.Action.Title',
        hint: 'PEN.ChaosiumCanvasInterface.PlaySound.Action.Hint',
        required: true
      }),
