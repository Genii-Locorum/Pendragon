...
export class PendragonHorseSheet extends PendragonItemSheet {
  constructor (options = {}) {
    super(options)
  }
  ...
  static PARTS = {
    ...
    attributes: {
      template: 'systems/Pendragon/templates/item/horse.attributes.hbs'
    },
    description: {
  ...
  async _prepareContext (options) {
    ...
    sheetData.horseStatusList = PENSelectLists.getHorseStatus();
